...
import { getActiveMovies } from "../../api/MovieAPI.js"; // Import API lấy phim và rạp
import { getActiveCinemas } from "../../api/CinemaAPI.js"; // Import API lấy phim và rạp
import {
  FaSearch,
  FaAngleDoubleLeft,
  FaAngleLeft,
...
function ManagerTicketsEmployee() {
  const { user } = useAuth();
...
export default ManagerTicketsEmployee;
